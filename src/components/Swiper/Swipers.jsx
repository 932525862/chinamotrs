        ...
        {cards.map((car, index) => (
          <SwiperSlide key={index}>
            <div
              ...
              className="h-[100dvh] w-full px-10 py-20 text-white relative"
            >
              <div className="max-w-7xl h-full mx-auto flex flex-col max-sm:items-center gap-6">
                ...
                <h1 className="min-md:w-[600px] z-10 max-md:text-2xl max-sm:text-xl max-sm:text-center text-4xl font-medium mt-5">
                  {car?.title}
                </h1>
                <p className="text-2xl z-10 max-md:text-xl max-sm:text-xl max-sm:text-center font-medium text-[#595757]">
                  {car?.text}
                </p>
                <NavLink>
