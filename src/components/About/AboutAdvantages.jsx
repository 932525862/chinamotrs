...
const cards = [
  {
    icon: <FaUserShield />,
    title: 'XIZMAT QILISH VA KAFOLAT BERISH',
    desc: "'GRANT FITNES' internet do'konida sotib olingan tovarlar buzilgan bo'lsa tuzatib beriladi, olingan tovarning kafolati bo'ladi.",
  },
  {
    icon: <FaTruck />,
    title: 'XIZMAT QILISH VA KAFOLAT BERISH',
      ...
      <section className="max-w-7xl mx-auto pt-10 pb-15 px-[1rem]">
        <div className="">
          ...
          <p className=" font-medium text-gray-500">
            Nima uchun mijozlarimiz aynan bizning do'konimizni tanlashadi?
          </p>
